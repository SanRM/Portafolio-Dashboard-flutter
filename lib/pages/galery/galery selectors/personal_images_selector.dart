...
class GaleryPersonalImagesSelector extends StatefulWidget {
  const GaleryPersonalImagesSelector({super.key});

  @override
  State<GaleryPersonalImagesSelector> createState() => _GaleryPersonalImagesSelectorState();
}

class _GaleryPersonalImagesSelectorState extends State<GaleryPersonalImagesSelector> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Seleccionar imágen lateral'),
      ),
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  FutureBuilder(
                    future: getUrlImageList('imagenes personales'),
