...
class GaleryBadgesSelector extends StatefulWidget {
  const GaleryBadgesSelector({super.key});

  @override
  State<GaleryBadgesSelector> createState() => _GaleryBadgesSelectorState();
}

class _GaleryBadgesSelectorState extends State<GaleryBadgesSelector> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Seleccionar imágen de insignia'),
      ),
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  FutureBuilder(
                    future: getUrlImageList('insignias'),
